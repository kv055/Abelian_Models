...
class Import_Price_Data:
    ...
    def return_merged_average_price_data_frames(self,list_of_asset_dicts_fukd):
        # TENPORARY #############################################
        list_of_asset_dicts = []
        for dictt in list_of_asset_dicts_fukd:
            asset_dict = dictt['assetPair']
            list_of_asset_dicts.append(asset_dict)
        #########################################################
